...
namespace zTest
{
    ...
    public class TestStockClassOriginal
    {
        CStockClass sc;
        ...
        {
            sc.StockListBids[0].Add(new CStock { Price =Convert.ToDecimal(price), Volume = volume });
        }

        public void A0(double price, long volume)
        {
            sc.StockListAsks[0].Add(new CStock{ Price = Convert.ToDecimal(price), Volume = volume });
        }

        public void B1(double price, long volume)
        {
            sc.StockListBids[1].Add(new CStock{ Price = Convert.ToDecimal(price), Volume = volume });
        }

        public void A1(double price, long volume)
        {
            sc.StockListAsks[1].Add(new CStock { Price = Convert.ToDecimal(price), Volume = volume });
        }
        ...
        public void InitStockClass()
        {
            ...
            sc.LstStockConf = new List<CStockConf>()
            {
                new CStockConf{ PrecissionNum=0, DecimalsPrice=1, MinStep=0.1m},
                new CStockConf{ PrecissionNum=1, DecimalsPrice=0, MinStep=1m},
