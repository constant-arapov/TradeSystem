...
namespace Common.IO
{
    public class CNamedPipe
    {
        ...
        public const int BUFFER_SIZE = 255;//KAA was 100;
        ...
        private void Read()
        {
            ...
            while (true)
            {
                ...
                if (ReadLength > 0)
                {
                    ...
                    string st = encoder.GetString(Rc, 0, ReadLength);
                    _client.OnRecieveString(st);
    ...
    public enum EnmNamedPipeClientType : int
    {
        Read = 0,
        Write =1
