...
namespace TradeSystemASTS.ViewModel
{
    public class MainWindowViewModel : CBaseProppertyChanged, IAlarmable
    {
        ...
        public CASTSDealingServer DealingServer
        {
          get
          {
            ...
            try
            {
                ...
                while (true)
                {
                    ...
                    foreach (var cb in m_mainWindow.GridData.DictionaryControllButtonTF)
                    {
                        ...
                        string id = cb.Value.TFButton.ID;
                        string isin = "";
                        string tf = "";
                        string dt = "";
        ...
        */
        ...
        public void OnPasswordChangeReply(bool isSuccess, string message )
        {
           _dispatcher.BeginInvoke(
               new Action (() => {
                                    SuccessResWindow resWin = new SuccessResWindow();
                                    resWin.ShowDialog();
                                    }));
