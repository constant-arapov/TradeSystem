...
namespace Terminal.Graphics
{
    public class CRenderer
    {
        ...
        public CRenderer(FrameworkElement frameWorkElement, DrawingVisual drawingViusal)
        {
        ...
        public CRenderer(FrameworkElement frameWorkElement, DrawingVisual drawingViusal, Image defaultImage)
            : this (frameWorkElement, drawingViusal)
        {
