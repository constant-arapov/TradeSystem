...
{
    class CSkypeRetransmitter : CBaseFunctional
    {
        ...
        public void RetransmitMsg(string user, string msg)
        {
          /*
             if (mainSkype.authState != LoginState.Success)
            {
                mainSkype.Login();
                Log("=============>retry login");
            ...
            */
            ...
            mainSkype.SendMessage(user, msg);
            


            Console.WriteLine("[DEBUG]: Message sended");
            // mainSkype.StartPoll();
